...
pars_model04a <- map_df(mod04a_files, extract_parameters)
pars_model05a <- map_df(mod05a_files, extract_parameters)
pars_model06a <- map_df(mod06a_files, extract_parameters)
pars_model07a <- map_df(mod07a_files, extract_parameters)
pars_model08a <- map_df(mod08a_files, extract_parameters)
pars_model08b <- map_df(mod08b_files, extract_parameters)
pars_model08c <- map_df(mod08c_files, extract_parameters)
pars_model09a <- map_df(mod09a_files, extract_parameters)
pars_model09b <- map_df(mod09b_files, extract_parameters)
pars_model09c <- map_df(mod09c_files, extract_parameters)
pars_model10a <- map_df(mod10a_files, extract_parameters)
pars_model10b <- map_df(mod10b_files, extract_parameters)
pars_model10c <- map_df(mod10c_files, extract_parameters)
pars_model11a <- map_df(mod11a_files, extract_parameters)
pars_model11b <- map_df(mod11b_files, extract_parameters)
pars_model11c <- map_df(mod11c_files, extract_parameters)
pars_model12a <- map_df(mod12a_files, extract_parameters)
pars_model12b <- map_df(mod12b_files, extract_parameters)
pars_model12c <- map_df(mod12c_files, extract_parameters)
pars_model13a <- map_df(mod13a_files, extract_parameters)
pars_model13b <- map_df(mod13b_files, extract_parameters)
pars_model13c <- map_df(mod13c_files, extract_parameters)
pars_model14a <- map_df(mod14a_files, extract_parameters)
pars_model14b <- map_df(mod14b_files, extract_parameters)
pars_model14c <- map_df(mod14c_files, extract_parameters)
